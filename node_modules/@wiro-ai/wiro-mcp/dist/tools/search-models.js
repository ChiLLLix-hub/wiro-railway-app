...
export function registerSearchModels(server, client) {
    server.registerTool('search_models', {
        ...
        inputSchema: {
            ...
            categories: z.array(z.string()).optional().describe('Filter by categories. Available: "text-to-image", "image-to-image", "image-editing", '
        ...
        try {
            ...
            return {
                content: [{ type: 'text', text: text + totalNote }],
                structuredContent: {

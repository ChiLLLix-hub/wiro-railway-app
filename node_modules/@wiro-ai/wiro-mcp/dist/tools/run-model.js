import { z } from 'zod';
import { TaskPollingError, TaskWaitTimeoutError, } from '../client.js';
import { formatTaskPending, formatTaskResult, formatTaskSubmitted, } from '../utils/format.js';
        ...
        try {
            ...
            if (!wait) {
                return {
                    content: [{
                            type: 'text',
                            text: formatTaskSubmitted(runResult.taskid, runResult.socketaccesstoken),
                        }],

import { z } from 'zod';
import { getTaskState, toStructuredTaskResult, } from '../utils/structured.js';
import { taskPriceOutputSchema } from './schemas.js';
export function registerGetTaskPrice(server, client) {
    server.registerTool('get_task_price', {
...
//# sourceMappingURL=get-task-price.js.map